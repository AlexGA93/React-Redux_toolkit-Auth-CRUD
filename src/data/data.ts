...
export const topDealUsers: topDealUserType[] = [
  {
    id: 1,
...
export const barChartBoxRevenue: barChartBoxRevenueType = {
  title: "Profit Earned",
  color: "#8884d8",
  dataKey: "profit",
  chartData: [
...
export const barChartBoxVisit: barChartBoxRevenueType = {
  title: "Total Visit",
  color: "#FF8042",
  dataKey: "visit",
  chartData: [
...
export const singleUser: singleType = {
  id: 1,
  title: "John Doe",
